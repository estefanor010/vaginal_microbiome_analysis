function plot_link_correlations(results, parameters)
    ...
    title('Correlation of Links and Mean Nugent (Spearman)', 'FontSize', 14);
    ...
    title('Correlation of Links and Mean Nugent (Pearson)', 'FontSize', 14);
    ...
    title('Correlation of Links and Median Nugent (Spearman)', 'FontSize', 14);
    ...
    title('Correlation of Links and Median Nugent (Pearson)', 'FontSize', 14);
    ...
    function create_correlation_plot(input, output, corr_type, ylabel_text)
        ...
        text(min(input) + 0.1*(max(input)-min(input)), max(output) - 0.1*(max(output)-min(output)), ...
